...
const String _kDefaultBaseUrl = 'http://10.0.2.2:8080';

/// Provides the resolved API base URL. Override at runtime via:
/// `flutter run --dart-define=API_BASE_URL=https://api.bbcms.chf.org`
